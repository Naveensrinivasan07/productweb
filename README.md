    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    <div class="text">
                    <marquee><b>Feel REAL BEAUTY through our Store</b></marquee>
                    <p style="color:purple; font-family:'Tahoma'; font-size:20px;"> This is the Official Website of our BEAUTY PRODUCTS Store</p>
                    </div>
                    <p>Buy Fancy items and Cosmetics online for Women from <span style="background-color:lime">Fashion world</span>
    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="bot"><p>To Order Online: Call 90 88 77 2009</p></div>

                <div class="footer">
                <footer style="color:white">
                Copyright &copy;2023 Developed by naveend</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/people.html00.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        .manph1{
            background-image: url(/static/images/people.html1.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .manph2{
            background-image: url(/static/images/people.html2.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/images/people.html3.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph3{
            background-image: url(/static/images/people.html4.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>naveen</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Jack</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Allen</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>ben stokes</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>morgan philip</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>maddyy</h2></b></p></div><br>
            ...
            <div class="header">
                ...
                <div class="content">
                    ...
                    <ul>
                        ...
                        <li><b>Email Id:</b>veens@fancyuniv.com</li>
                    </ul>
